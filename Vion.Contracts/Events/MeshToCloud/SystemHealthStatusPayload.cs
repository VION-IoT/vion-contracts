...
namespace Vion.Contracts.Events.MeshToCloud
{
    ...
    ///     The list of components being monitored e.g. Mesh, Dale, Hal, Broker, Otel-Collector.
    /// </param>
    ...
    /// </summary>
    /// <param name="Name">
    ///     The name of the component (e.g., "mesh", "dale", "hal", "broker", "otel-collector") or subcomponent (e.g.,
    ...
    ///         <item>For Broker: whether the broker is reachable.</item>
    ...
    ///     correctly but the broker is down).
    /// </param>
