...
namespace Vion.Contracts.Events.CloudToMesh
{
    ...
    public record ServiceProviderRegistrationsRetrievedPayload(List<ServiceProviderRegistration> Registrations, Dictionary<Guid, ObjectSyncStatus> SyncStatusByObjectId) : IMessage;
