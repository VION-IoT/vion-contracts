...
namespace Vion.Contracts.Events.CloudToMesh
{
    ...
    ///     (e.g. <c>.../service/stop/remoteConsole</c>). The <c>Arguments</c> identify the instance to stop (e.g. the
    ///     session id — see <see cref="Vion.Contracts.Constants.RemoteAccessConstants.Arguments" />). See the
