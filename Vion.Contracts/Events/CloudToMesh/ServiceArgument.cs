...
{
    /// <summary>
    ///     A single named argument for a <see cref="StartSystemServicePayload" /> /
    ///     <see cref="StopSystemServicePayload" /> command. Arguments are a list of these readonly records rather
    ///     than a dictionary, so the wire form stays
